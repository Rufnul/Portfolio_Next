...
const Blog = () => {
    return (
        <div id='7' className='pt-16 pb-16'>
            <h1 className='text-center text-2xl md:text-4xl xl:text-5xl font-bold text-white'>My Latest <br /> <span className='text-cyan-300'>Blogs</span>
            </h1>
